  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          { id: 'calc-electron', label: 'Electron Mass', path: '/calculations/electron-mass', badge: '✓' },
          { id: 'calc-muon', label: 'Muon Mass', path: '/calculations/muon-mass', badge: '✓' },
          { id: 'calc-tau', label: 'Tau Mass', path: '/calculations/tau-mass', badge: '✓' },
          { id: 'calc-up', label: 'Up Quark', path: '/calculations/up-quark', badge: '✓' },
          { id: 'calc-down', label: 'Down Quark', path: '/calculations/down-quark', badge: '✓' },
          { id: 'calc-charm', label: 'Charm Quark', path: '/calculations/charm-quark', badge: '✓' },
          { id: 'calc-strange', label: 'Strange Quark', path: '/calculations/strange-quark', badge: '✓' },
          { id: 'calc-top', label: 'Top Quark', path: '/calculations/top-quark', badge: '✓' },
          { id: 'calc-bottom', label: 'Bottom Quark', path: '/calculations/bottom-quark', badge: '✓' },
          { id: 'calc-neutrinos', label: 'Neutrino Masses', path: '/calculations/neutrinos', badge: '✓' },
        ],
      },
      {
        id: 'calc-newton-g',
        label: "Newton's G",
        path: '/calculations/newton-g',
        badge: '✓',
        tooltip: 'Gravitational constant derivation',
      },
      {
        id: 'calc-fine-structure',
        label: 'Fine Structure α',
        path: '/calculations/fine-structure',
        badge: '✓',
        tooltip: 'Fine structure constant calculation',
      },
      {
        id: 'calc-coupling-constants',
        label: 'Coupling Constants',
        path: '/calculations/coupling-constants',
        children: [
          { id: 'calc-alpha-em', label: 'Electromagnetic α', path: '/calculations/alpha-em', badge: '✓' },
          { id: 'calc-alpha-s', label: 'Strong αₛ', path: '/calculations/alpha-s', badge: '✓' },
          { id: 'calc-alpha-w', label: 'Weak αᵪ', path: '/calculations/alpha-w', badge: '✓' },
        ],
      },
    ],
  },
